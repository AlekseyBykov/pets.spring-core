package alekseybykov.portfolio.springcore.xmlconfig.beans.scope;
...
public class BeanScopeTest {
	...
	public static void setUp() {
		applicationContext = new ClassPathXmlApplicationContext("xmlconfig/scopes/application-context.xml");
	}
